...
13. Add a brief "Editor's Note" at the end of the body: "<p><em>This article was generated by SIGNAL's automated pipeline and reviewed for accuracy.</em></p>"
14. Write with HUMAN voice — use personal opinions, real-world examples, conversational tone.
15. Include specific dates, numbers, and facts from the source material.
16. Output ONLY valid JSON — no markdown, no code fences.`;
